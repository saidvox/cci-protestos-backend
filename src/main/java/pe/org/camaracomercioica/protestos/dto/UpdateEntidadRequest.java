...
@Schema(description = "Datos para actualizar una entidad financiera existente")
public record UpdateEntidadRequest(
    @NotBlank
    @Pattern(regexp="\\d{11}")
    ...
    @Schema(description = "Estado activo de la entidad financiera", example = "true")
    boolean activo
) {}
